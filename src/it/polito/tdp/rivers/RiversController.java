...
public class RiversController {
    ...
    @FXML
    void getInfoRivers(ActionEvent event) {
    	
    	if(boxRiver.getValue()==null){ //inutile
    		txtResult.setText("Selezionare un fiume");
    		return;
    	}
    	
    	InfoRiver info = model.getInfoRivers(boxRiver.getValue());
    	
    	txtStartDate.setText(info.getPrima().toString());
    	txtEndDate.setText(info.getUltima().toString());
    	txtNumMeasurements.setText(Integer.toString(info.getCont()));
    	txtFMed.setText(Float.toString(info.getFmed()));
